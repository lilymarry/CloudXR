...
- (void)addCornerLineWithContext:(CGContextRef)ctx rect:(CGRect)rect{
    ...
    //边角颜色
    CGContextSetRGBStrokeColor(ctx, 0 /255.0, 255/255.f, 0/255.f, 1);
    ...
    UILabel * thisTitle = [[UILabel alloc] initWithFrame:CGRectMake(0, rect.origin.y + rect.size.height, ScreenWidth, 30)];
